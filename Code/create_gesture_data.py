...
while True:
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        cv2.putText(frame_copy, "Adjust hand...Gesture for" + str(actions[element]), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            cv2.putText(frame_copy, str(num_frames)+"For" + str(actions[element]), (70, 45), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            cv2.putText(frame_copy, str(num_imgs_taken) + 'images' +"For" + str(actions[element]), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
            ...
            if num_imgs_taken <= 300:
                ...
                cv2.imwrite( os.path.join(DATA_PATH, str(actions[element]), str(num_imgs_taken))+ '.jpg', thresholded)
            if num_imgs_taken>300:
                element=element+1
                num_imgs_taken=0
                num_frames = 0
